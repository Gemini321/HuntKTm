    ...
    for WORKLOAD in ${WORKLOADS[@]}; do
        for SCHED_ALG in "${!SCHED_ALG_TO_ARGS_ARR[@]}"; do
            ...
            for ARGS in ${ARGS_ARR[@]}; do
                ...
                ${BEMPS_SCHED_PATH}/RuntimeScheduler \
                ...
                mv ./sched_fp32_util.csv ${EXPERIMENT_BASENAME}-sched_fp32_util.csv
                mv ./sched_mem_copy.csv ${EXPERIMENT_BASENAME}-sched_mem_copy.csv
                mv ./sched_sm_occupancy.csv ${EXPERIMENT_BASENAME}-sched_sm_occupancy.csv
